    ...
    def __init__(self):
        self.network = layers.SequentialLayer(
            [
                ...
                layers.PReLULayer(1),
                layers.LinearLayer(1000, 500),
                layers.LeakyReLULayer(0.01),
                layers.LinearLayer(500, 100),
                layers.LeakyReLULayer(0.01),
...
def train(train_data, train_labels, test_data, test_labels, optimizer_type="momentum"):
